        ...
        <div className="grid grid-cols-3 gap-3 sm:gap-4">
          {actions.map((action, index) => (
            <motion.button
              ...
              className="flex flex-col items-center justify-center gap-2 p-3 rounded-xl bg-[#3A3A3A] text-white h-24 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 ring-offset-background hover:bg-[#4A4A4A] transition-colors"
            >
