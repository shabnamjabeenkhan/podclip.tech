...
export function CardHoverEffect({
  ...
  return (
    <Div
      ...
      className={cn(
        'group relative z-30 w-full h-full cursor-pointer overflow-hidden rounded-2xl flex flex-col',
        sizeConfig.padding,
        // Light mode styles - darker background
        'bg-slate-800/80 before:bg-linear-to-b before:from-slate-700/20 before:to-slate-800/40 before:backdrop-blur-3xl',
        'after:bg-linear-to-b after:from-transparent after:via-transparent after:to-slate-800/30',
        // Dark mode styles
        'dark:bg-slate-900/80 dark:before:bg-linear-to-b dark:before:from-slate-800/20 dark:before:to-slate-900/40',
        'dark:after:to-slate-900/30',
        // Common styles
    ...
    >
      ...
      >
        <div
          ...
          style={{
            background: `conic-gradient(from 0deg at 50% 50%, transparent 0deg, transparent 340deg, rgb(168 85 247) 360deg)`,
      ...
      {/* Content */}
      <div className="relative z-30 mt-2 flex-1 flex flex-col justify-between">
        <h3
          className={cn(
      ...
      {/* Shine Effect - Removed for uniform background */}
    </Div>
  );
}
