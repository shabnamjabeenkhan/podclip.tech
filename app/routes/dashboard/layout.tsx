  ...
  return (
    ...
    >
      ...
      <SidebarInset className="bg-white">
        <header className="flex h-16 shrink-0 items-center gap-2 px-2 sm:px-4 transition-[width,height] ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-12">
